...
2. Copy/Alias/Shortcut *dateTime.4dProject* to the parent project's **Components** folder.

   * The **Components** folder and the **Project** folder of the source database should be at the same level.

   * If this has worked, when you go into your parent project, in the 4D Explorer, you should see *dateTime* and its methods and classes in the **Component Methods** section.
